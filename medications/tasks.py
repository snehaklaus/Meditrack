...
from .email_templates import get_medication_reminder_email  # Add this import
...
def send_reminder_notification(medication_id):
    try:
        ...
        subject, plain_message, html_message = get_medication_reminder_email(user, medication)
